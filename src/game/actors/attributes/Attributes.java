...
public class Attributes {
    ...
    public Attributes(Attribute strength, Attribute knowledge, Attribute defense,
    ...
    public Attributes(int strength, int agility, int knowledge, int defense, int resilience, int spirit, int luck) {
    ...
    public void setKnowledge(Attribute knowledge) {
        this.knowledge = knowledge;
    }
    ...
    public void setDefense(Attribute defense) {
        this.defense = defense;
    }

    public Attribute getResilience() {
        return resilience;
    }

    public void setResilience(Attribute resilience) {
        this.resilience = resilience;
    }
    ...
    public void incrementAttribute(String attribute, int value) {
        switch (attribute) {
