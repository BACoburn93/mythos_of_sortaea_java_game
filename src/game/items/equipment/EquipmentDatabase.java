...
public class EquipmentDatabase {
    ...
    public static void init() {
        ...
        factory.registerPrototype(
            ...
            StaffPools.PREFIX_POOL, 0.85,
            StaffPools.SUFFIX_POOL, 0.85
        );
        ...
        factory.registerPrototype(
            ...
            DaggerPools.PREFIX_POOL, 0.85,
            DaggerPools.SUFFIX_POOL, 0.85
        );
        ...
        factory.registerPrototype(
            ...
            TowerShieldPools.PREFIX_POOL, 0.85,
            TowerShieldPools.SUFFIX_POOL, 0.85
        );
        ...
        factory.registerPrototype(
            ...
            SwordPools.PREFIX_POOL, 0.85,
            SwordPools.SUFFIX_POOL, 0.85
        );

        factory.registerPrototype(
            EquipmentKey.BOW.key(),
            EquipmentRegistry.get(EquipmentKey.BOW.key()),
            BowPools.PREFIX_POOL, 0.85,
            BowPools.SUFFIX_POOL, 0.85
        );
        ...
        factory.registerPrototype(
            ...
            PlateArmorPools.PREFIX_POOL, 0.85,
            PlateArmorPools.SUFFIX_POOL, 0.85
        );

        factory.registerPrototype(
            EquipmentKey.LEATHER_ARMOR.key(),
            EquipmentRegistry.get(EquipmentKey.LEATHER_ARMOR.key()),
            LeatherArmorPools.PREFIX_POOL, 0.85,
            LeatherArmorPools.SUFFIX_POOL, 0.85
        );
        ...
        factory.registerPrototype(
            ...
            RingPools.PREFIX_POOL, 0.85,
            RingPools.SUFFIX_POOL, 0.85
        );
        ...
        // EQUIPMENT_LIST.add(factory.createByKey(EquipmentKey.GREAT_STAFF.key(), 
        //     StaffPools.PREFIX_POOL.get(1).value, 
        //     StaffPools.SUFFIX_POOL.get(1).value
        //     )
        // );
        // EQUIPMENT_LIST.add(factory.createByKey(EquipmentKey.SWORD.key(), 
        //     StaffPools.PREFIX_POOL.get(1).value, 
        //     StaffPools.SUFFIX_POOL.get(1).value
        //     )
        // );
