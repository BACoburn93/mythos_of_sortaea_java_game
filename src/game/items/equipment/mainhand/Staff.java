...
public class Staff extends Mainhand{
    public Staff(String name, int goldValue, int quantity, Attributes attributes, Resistances resistances) {
        super(name, goldValue, quantity, WeaponTypes.STAFF, false, attributes, resistances);
    }
