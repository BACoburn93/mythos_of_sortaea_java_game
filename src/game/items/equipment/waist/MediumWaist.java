...
public class MediumWaist extends Waist {
    public MediumWaist(String name, int goldValue, int quantity, Attributes attributes, Resistances resistances) {
        super(name, goldValue, quantity, ArmorTypes.MEDIUM, attributes, resistances);
    }

    public MediumWaist(String name, int goldValue, Attributes attributes, Resistances resistances) {
